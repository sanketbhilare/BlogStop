...
<head>
	...
	<title>Registration Page-BlogStop</title>
...
<body background="img/dark1.jpg" style="color: #FFF; justify-content: center;">
 <div class="container">
 	<div class="row " style="justify-content: center;">
 		<div class="col-md-6" style="font-color: #000;">
 			<h2 style="text-align: center;"> Registration Page</h2><br>
 		<?php
